   ...
   /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'base_fieldset',
            ['legend' => __('Upload CSV File For Cities')]
        );
		$fieldset->addField(
            'country_id',
            'select',
		...
		$fieldset->addField(
            ...
            [
				...
				'note'     => '<br />Cities import file will be in csv format and contains two columns like below:<br> <table border="1" width="100%"><tr><th>City</th><th>State</th></tr><tr><td align="center">12345</td><td align="center">Abcd</td></tr></table>'
            ]
        );
